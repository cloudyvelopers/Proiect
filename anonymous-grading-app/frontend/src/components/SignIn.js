            ...
            <div className="row">
                <div className='col' style={{marginLeft:'30px'}}>
                    <form onSubmit={handleSubmit(this.onSubmit)}>
                        ...
                        <Button type="submit" className="btn p=button-primary " label="SignIn" style={{marginTop:'25px'}}  />
                    </form>
                </div>
                
                <div className="col" style={{marginLeft:'40px'}}>
                    <div className="text-center">
                        <div className="alert alert-primary">Sign in using Google or Facebook </div>
